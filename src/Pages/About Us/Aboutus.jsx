  ...
  return (
    <>
      ...
      <div className='items-center justify-center ml-[10vw] mr-[10vw] mt-[5vw]'>
        <h1 className="font-bold text-3xl  text-white text-center md:text-4xl mb-[2vw]">
        " Welcome to our Resume Builder ! "
        </h1>
        <br></br>

        {/*  About Us paragraph */}   
        <p1 className="mt-15 text-white text-xl justify-center">
        ...
        <h2 className='mt-8 text-white font-bold text-xl text-center'>
          Share with Your Friends.
        </h2>
        <h5 className='mt-8 text-black font-bold text-xl text-center'>
         "" Regards Deepika Pandey""
        </h5>
